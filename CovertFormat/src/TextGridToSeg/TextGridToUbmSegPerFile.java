 ...
 * 
 */
public class TextGridToUbmSegPerFile
{
	/**
...
//						source += seg.toString();
		...
		FileWriter fileWriter = new FileWriter(new File("ubm_all.seg"),true);
...
//			"JiangSuDianXin4h",
		...
		{
			List<String> fileList = TextGridToUbmSegPerFile.getFileList(new File(pathString + dir));
			...
			for (String file : fileList)
			{
				...
				// 文件内容
				try	{
					TextGridToUbmSegPerFile.convertSeg(dir,new File(file));
				}catch (IOException e){
